...
| **Physical AI / Robotics** | Typed ROS 2 telemetry, rosbag2 replay, feature store | [ROS 2 roadmap](docs/design/ros2_physical_ai_roadmap.md), [ROS 2 setup](docs/operations/ROS2_SETUP.md), [edge guide](docs/operations/ROS2_EDGE_DEPLOYMENT.md), [use cases](docs/usecases/physical_ai.md), experimental edge/fleet connector, spatial SQL |
