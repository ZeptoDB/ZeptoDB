...
const buildTheme = (mode: PaletteMode) => {
  ...
  // Quantum Precision Theme Definitions
  const backgroundDefault = isDark ? "#05080E" : "#F8FAFC";
  const backgroundPaper = isDark ? "rgba(11, 17, 29, 0.7)" : "rgba(255, 255, 255, 0.8)";
  const primaryMain = isDark ? "#00E5FF" : "#2563EB";
  const secondaryMain = isDark ? "#7C4DFF" : "#7C3AED";
    ...
    components: {
      ...
      MuiButton: {
        styleOverrides: {
          ...
          containedPrimary: {
            boxShadow: `0 0 12px ${alpha(primaryMain, 0.4)}`,
            "&:hover": {
              boxShadow: `0 0 20px ${alpha(primaryMain, 0.6)}`,
      ...
      MuiDrawer: {
        styleOverrides: {
          paper: {
            backgroundColor: isDark ? "#030407" : "#FFFFFF",
      ...
      MuiAppBar: {
        styleOverrides: {
          root: {
            backgroundColor: isDark ? "rgba(3, 4, 7, 0.7)" : "rgba(255, 255, 255, 0.7)",
