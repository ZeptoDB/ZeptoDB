...
피드 핸들러는 거래소, 데이터 벤더 및 피드 제공업체로부터 실시간 시장 데이터를 수신하여 APEX-DB에 인제스트하는 컴포넌트입니다.
...
- 예시: `/home/ec2-user/apex-db/examples/feed_handler_integration.cpp`
