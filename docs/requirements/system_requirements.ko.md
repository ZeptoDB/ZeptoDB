...
*버전 2.2 — 최종 업데이트: 2026-03-22 (FR-4 Python 에코시스템 — zepto_py 완료)*
...
- FR-4.4: Python 에코시스템 — `zepto_py` 패키지 ✅
...
- FR-6.7: `zepto-migrate` CLI (5가지 모드: query/hdb/clickhouse/duckdb/timescaledb)
...
- Python: numpy/Arrow 제로카피; zepto_py를 통한 pandas/polars/duckdb 상호운용
