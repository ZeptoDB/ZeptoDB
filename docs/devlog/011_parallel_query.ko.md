...
| 파일 | 역할 |
|------|------|
| `include/zeptodb/execution/query_scheduler.h` | QueryFragment + PartialAggResult + 인터페이스 |
| `include/zeptodb/execution/local_scheduler.h` | LocalQueryScheduler 선언 |
| `src/execution/local_scheduler.cpp` | scatter/gather/execute_fragment 구현 |
| `include/zeptodb/execution/distributed_scheduler.h` | 분산 스케줄러 stub |
| `src/execution/distributed_scheduler.cpp` | stub |
| `include/zeptodb/execution/parallel_scan.h` | ParallelScanExecutor (partition chunk 분배) |
