...
> using LIBERO suite task IDs as manifest task indexes. Experiment 034
> supersedes every task-coverage and source-admission conclusion in this
> report. The candidate rows remain preserved only as exploratory telemetry.
